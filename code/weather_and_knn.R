...
## extract values ####
### extract mean aspect ####
# convert to "northness" and "eastness" before averaging, then convert back to
# degrees after averaging.
...
# add in ppt
ppt_rast <- rast("./processed_data/ppt.tif") %>% project(cbi)
